...
class BossTile(MapTile):
    ...
    def modify_player(self, player):
        if self.enemy.is_alive():
            ...
            input(".....")
            print ("You remember the butcher's daughter lying on the floor in a pool of blood" )
            input(".....")
            ...
            print("before your trip to the Woods of Ypres")
            input(".....")
            print("The old man continues 'Congratulations, you have escaped the Woods of Ypres") 
            input(".....")
            print("'Now are you ready to confess, this time ?'")
            input(".....")
            print("You nod with approval and readily face your final judgement")
            input(".....")
            print("Sometimes redemption can only be found in death")
